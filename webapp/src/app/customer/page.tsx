            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 overflow-hidden mb-6">
              ...
              <div className="p-6 pt-12">
                ...
                {shop.is_hiring && shop.careers_form_url && (
                  <div className="bg-gradient-to-r from-[#0393d5]/20 to-[#027bb5]/20 backdrop-blur-lg rounded-xl p-4 border border-[#0393d5]/30 mb-4">
                    <div className="flex items-start gap-3">
                      <div className="bg-[#0393d5]/20 p-2 rounded-lg">
                        <Briefcase className="w-5 h-5 text-[#0393d5]" />
                      </div>
                      <div className="flex-1">
                        ...
                        <p className="text-[#0393d5] font-semibold text-sm mb-3">
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-2 bg-[#0393d5] hover:bg-[#027bb5] text-white font-semibold px-6 py-2 rounded-lg transition-all shadow-lg hover:shadow-xl text-sm"
                        >
